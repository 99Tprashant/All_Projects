...
class DBMS
{
   public LinkedList <Student> lobj;
    ...
    public void StartDBMS()
    {
        ...
        System.out.println("Prashant customised DBMS started succesfully....");
        String Query = "";

        while(true)
        {
            System.out.print("Prashant DBMS console >");
            ...
            if(QuerySize == 1)
            {
                ...
                {
                    System.out.println("Thank you for using Prashant DBMS");
                    break;
                }
            }
            else if(QuerySize == 2)
